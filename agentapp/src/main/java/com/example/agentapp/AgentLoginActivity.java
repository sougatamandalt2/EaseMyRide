...
//        String name=givename();
        ...
        tv_newuser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AgentLoginActivity.this,AgentResgistrationActivity.class));
            }
        });
        ...
        tv_forgetpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AgentLoginActivity.this,AgentForgetPasswordActivity.class));
            }
        });
...
//    }
    ...
    private void loginUserAccount() {
        ...
        if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
            Toast.makeText(AgentLoginActivity.this, "Invalid email", Toast.LENGTH_SHORT).show();
            return;
        }

        if(password.length()<8){
            Toast.makeText(AgentLoginActivity.this, "Password too short", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        reference.child(firebaseAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists()){
                                    startActivity(new Intent(AgentLoginActivity.this,AgentHomepageActivity.class));
                                }
                                else{
                                    Toast.makeText(AgentLoginActivity.this, "Incorrect email or password, try again", Toast.LENGTH_SHORT).show();
                                }
                            }
