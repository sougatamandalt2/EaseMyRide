...
public class AgentMapActivity extends AppCompatActivity {
...
//        tv_fullAddress=findViewById(R.id.tv_fullAddress);
        ...
        btn_loc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getLastLoc();
                Toast.makeText(AgentMapActivity.this, "Updating Location", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if(location!=null){
                    ...
                    supportMapFragment.getMapAsync(AgentMapActivity.this::onMapReady);
                }
            }
        });
    }
